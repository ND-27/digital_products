...
class User(AbstractUser, PermissionsMixin):
    ...
    phone_number = models.BigIntegerField(verbose_name=_('mobile number'), unique=True, null=True, blank=True,
                                          validators=[
    ...
    last_seen = models.DateTimeField(verbose_name=_('last seen date'), null=True)
...
class UserProfile(models.Model):
    ...
    avatar = models.ImageField(verbose_name=_('avatars'), blank=True)
    birthday = models.DateField(verbose_name=_('birthday'), blank=True, null=True)
    gender = models.BooleanField(verbose_name=_('gender'), help_text=_('female is False, male is True, null is unset'), null=True)
...
class Device(models.Model):
    ...
    device_uuid = models.UUIDField(verbose_name=_('Device uuid'), null=True)
